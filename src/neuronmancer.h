 ...
 */
    ...
    __global__ void backpropagateErrorsKernel(double* devNeurons, double* devWeights, double* devNeuronErrors, \
                                              ...
                                              int indexOfFirstNeuronInLeft, int indexOfFirstNeuronInRight, \
                                              int indexOfFirstWeight);
    __global__ void weightUpdateKernel(double* devNeurons, double* devWeights, double* devNeuronErrors, \
                                       int numberOfNeuronsInLeftLayer, int numberOfNeuronsInRightLayer, \
                                       int numberOfWeightsBetweenLayers, int indexOfFirstNeuronInLeft, \
                                       int indexOfFirstWeight, double learningRate);
    void backpropagateWithDevice(double* devExpectedOutput, double* devNeurons, double* devWeights, \
                                 double* devNeuronErrors, int numberOfLayers, int* neuronsPerLayer, \
                                 int* weightsPerLayer, int* firstNeuronIndexPerLayer, \
    ...
    __global__ void combinationFunctionKernel(double* devNeurons, double* devWeights, \
                                              int neuronIndexStart, int prevLayerNeuronIndexStart, int weightIndexStart, \
                                              int numberOfNeuronsInLayer, int numberOfNeuronsInPrevLayer);
    void combinationFunction(double* neurons, double* weights, int neuronIndex, int prevLayerIndexStart, \
                             int weightIndexStart, int prevLayerSize);
